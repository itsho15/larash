<div class="welcome-panel">
    <div class="welcome-panel-content">
        <h1><span class="dashicons dashicons-megaphone"></span> Hello Dev!</h1>
        <p class="about-description">Your shiny new plugin is ready to rock the world.</p>
        <div class="welcome-panel-column-container">
            ...
            <div class="welcome-panel-column welcome-panel-last">
                ...
                <ul>
                    <li>
                        <a target="_blank" href="https://github.com/vincentorback/clean-wordpress-admin">
                            Clean WP Admin (included)
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="https://github.com/0aveRyan/patterns">
                            WP Admin Patterns
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="https://github.com/bueltge/WordPress-Admin-Style">
                            WP Admin Styles
                        </a>
                    </li>
                </ul>
